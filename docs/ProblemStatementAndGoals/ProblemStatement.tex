...
\wss{We want to provide a system that can accept the Doppler output from an ultrasound machine, determine a measure of mean blood velocity from that signal, and provide a continuous output suitable for recording and analysis. The system should produce measurements that are sufficiently accurate and reliable for laboratory research use.}

\subsection{Inputs and Outputs}

\wss{The primary input to the system is the Doppler ultrasound audio signal representing blood flow within an artery.}
 
\wss{The primary output is a continuous signal representing mean blood velocity that can be recorded and analyzed using LabChart. The system should also provide sufficient information to allow researchers to verify that the resulting measurements are reasonable and reliable.}
